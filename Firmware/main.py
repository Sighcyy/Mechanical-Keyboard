...
keyboard.keymap = [
    [KC.GRAVE, KC.KP_1, KC.KP_2, KC.KP_3, KC.KP_4, KC.KP_5, KC.KP_6, KC.KP_7, KC.KP_8, KC.KP_9, KC.KP_0, KC.MINUS, KC.EQUAL, KC.BSPACE,
     ...
     KC.LOCKING_CAPS, KC.A, KC.S, KC.D, KC.F, KC.G, KC.H, KC.J, KC.K, KC.L, KC.SCOLON, KC.QUOTE, KC.KP_ENTER	
     KC.LSHIFT, KC.Z, KC.X, KC.C, KC.V, KC.B, KC.N, KC.M, KC.COMMA, KC.DOT, KC.SLASH, KC.RSHIFT, KC.UP
     KC.LCTRL, KC.NO, KC.LGUI, KC.LALT, KC.SPACE, KC.RALT, KC.LEFT, KC.DOWN, KC.RIGHT
    ]
]
